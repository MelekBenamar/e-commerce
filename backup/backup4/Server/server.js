...
app.post('/purchases', async (req, res) => {
    try {
        ...
        // Insert the purchased products into the database
        const query = 'INSERT INTO cart (user_num, marchandise) VALUES ?';
        const values = itemIds.map(itemIds => [loggedInNumber, itemIds]); // Assuming the user number is associated with each product
